...
module.exports = {
  name: "search",
  description: "Wyszukaj i wybierz film do odtwarzania",
  aliases: ["s"],
  cooldown: 3,
  edesc: `Wpisz to polecenie, aby znaleźć 5 pierwszych wyników dla Twojego utworu!\nUZyj: ${PREFIX}search <TITEL | URL>`,
...
async execute(message,args,client) {
    ...
    if (!args.length)
      return attentionembed(message,`Uzyj: ${message.client.prefix}${module.exports.name} <Video Name>`)
    //if there is already a search return error
    if (message.channel.activeCollector)
      return attentionembed(message,"To wyszukiwanie jest aktywne!");
    //if the user is not in a voice channel return error
    if (!message.member.voice.channel)
      return attentionembed(message,"Dołącz pierwsze na kanał")
    ...
    .setAuthor("Szukanie...", "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
    .setColor("#F0EAD6")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#F0EAD6")
      .setAuthor("Wyniki wyszukiwania!!", "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif","http://harmonymusic.tk")
      .setFooter("Wybierz swój numer","https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
    ...
    try {
      ...
      if(response === "error"){
        //send error message
        attentionembed(message,"Wybierz emotke!");
