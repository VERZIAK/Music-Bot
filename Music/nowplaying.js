...
module.exports = {
  ...
  description: "Pokaz aktualne piosenki",
  cooldown: 5,
  edesc: `Wpisz nowplaying w czacie, aby zobaczyć, która piosenka jest aktualnie odtwarzana! Jak również jak długo potrwa to zanim będzie skończone\nUzyj: ${PREFIX}nowplaying`,
...
execute(message) {
    ...
    let nowPlaying = new MessageEmbed()
          .setAuthor('♪Aktualnie gram♪','https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif','https://harmonymusic.tk')
